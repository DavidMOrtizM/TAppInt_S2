...
{
    "titulo": "CAguas Andinas crea servidor de Minecraft para concientizar sobre sequía en Chile: Revisa cómo jugarlo",
    "categoria":"Nacional",
    "foto":"resources/images/gripe-aviar.jpg",
...
function Noticia(){
    ...
    NDiv.innerHTML="<h2>Cierran todo el borde costero de San Pedro de la Paz por sospecha de gripe aviar: hay aves muertas</h2><h4>Nacional</h4>";
    noticias.appendChild(NDiv);
}
